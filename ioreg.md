...
```
  ...
  2126h WO - WH0     - Window 1 Left Position (X1)                        (?)
  2127h WO - WH1     - Window 1 Right Position (X2)                       (?)
  2128h WO - WH2     - Window 2 Left Position (X1)                        (?)
  2129h WO - WH3     - Window 2 Right Position (X2)                       (?)
